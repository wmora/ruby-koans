...
=begin
    ...
    each element in the collection will be passed to the named method of memo.
    ...
    If you do not explicitly specify an initial value for memo, then uses the first element
